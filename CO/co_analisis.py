...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\CO\\CO DATA-N.csv", "r") as csv_file:
...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\CO\\CO DATA-N.csv", "r") as csv_file_antes:
...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\CO\\CO DATA-N.csv", "r") as csv_file_2019:
...
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\CO\\Gráficos CO\\1.png")
...
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\CO\\Gráficos CO\\2.png")
plt.show()
...
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\CO\\Gráficos CO\\3.png")
plt.show()
...
# plt.show()
data = [belisario_co, belisario_co_19]
plt.boxplot(data)

plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\CO\\Gráficos CO\\4.png")
plt.show()

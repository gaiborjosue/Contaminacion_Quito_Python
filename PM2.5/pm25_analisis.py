...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\PM2.5\\PM2.5-N.csv", "r") as csv_file:
    f = csv.reader(csv_file, delimiter=",")
    for line in islice(f, 136260, 137027):
...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\PM2.5\\PM2.5-N.csv", "r") as csv_file_antes:
    z = csv.reader(csv_file_antes, delimiter=",")
    for line in islice(z, 135492, 136259):
...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\PM2.5\\PM2.5-N.csv", "r") as csv_file_2019:
    c = csv.reader(csv_file_2019, delimiter=",")
    for line in islice(c, 127476, 128243):
...
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\PM2.5\\Gráficos PM2.5\\1.png")
plt.show()
...
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\PM2.5\\Gráficos PM2.5\\2.png")
plt.show()
...
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\PM2.5\\Gráficos PM2.5\\3.png")
plt.show()

...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\SO2\\SO2-N.csv", "r") as csv_file:
    f = csv.reader(csv_file, delimiter=";")
    for line in islice(f, 141987, 142754):
...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\SO2\\SO2-N.csv", "r") as csv_file_antes:
    z = csv.reader(csv_file_antes, delimiter=";")
    for line in islice(z, 141219, 141986):
...
with open("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\Historical_data_analysis\\\\SO2\\SO2-N.csv", "r") as csv_file_2019:
    c = csv.reader(csv_file_2019, delimiter=";")
    for line in islice(c, 133203, 133970):
...
fig.text(0.04, 0.5, 'Índices SO2 (mg/m3)', va='center', rotation='vertical')

fig.legend(["Durante", "Antes", "2019"])
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\SO2\\Gráficos SO2\\1.png")
plt.show()
...
fig2.text(0.04, 0.5, 'Índices SO2 (mg/m3)', va='center', rotation='vertical')

fig2.legend(["Durante", "Antes", "2019"])
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\SO2\\Gráficos SO2\\2.png")
plt.show()
...
fig3.text(0.04, 0.5, 'Índices SO2 (mg/m3)', va='center', rotation='vertical')

fig3.legend(["Durante", "Antes", "2019"])
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\SO2\\Gráficos SO2\\3.png")
plt.show()
...
plt.boxplot(data)
plt.savefig("C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\\SO2\\Gráficos SO2\\4.png")
plt.show()

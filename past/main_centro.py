...
csv_path = 'C:\\Users\\gaibo\\OneDrive\\Escritorio\\Python Projects\\Air Pollution\\Historical_data_analysis\centro,-quito, ecuador-air-quality.csv'
...
if 'Y' in inputq:
    ...
    plt.hlines(y = 10, xmin= -1, xmax= 21)
    plt.show()
